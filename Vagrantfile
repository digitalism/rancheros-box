...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "rancher-test"

  # The guest OS that will be running within this machine. This defaults to :linux
  ...
  # using a specific IP.
  config.vm.network "private_network", ip: "172.19.9.10"
